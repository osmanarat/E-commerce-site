...
<?php
 ...
 try {
 $sorgu = "SELECT kadi,sifre FROM iste_uyeler WHERE kadi=:kadi AND
sifre=:ksifre";
...
<body>
 ...
 <a href="../index.php" class="btn btn-primary btn-lg" tabindex="-1" role="button">Anasayfa</a>
...
placeholder="Şifre" name="ksifre"><br />
 <button type="submit" class="btn btn-primary btnblock">Giriş</button>
  ...
  <a href="/iste_eticaret/uye/kayitol.php" class="btn btn-primary btn-lg" tabindex="-1" role="button">Kayıt Ol</a>
